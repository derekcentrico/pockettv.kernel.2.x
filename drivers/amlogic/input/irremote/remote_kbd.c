...
static int kp_mouse_event(struct input_dev *dev, unsigned int scancode, unsigned int type)
{
	...
	__s32 move_accelerate[] = {0, 4, 4, 8, 8, 10, 12, 14, 16, 18, 24, 30};
	unsigned int i;
...
#ifdef SB_KEY
static unsigned int key_mouse_switch=0x03;
static unsigned int mouse_right=0x18;
static unsigned int mouse_left=0x1A;
static unsigned int mouse_up=0x11;
static unsigned int mouse_down=0x1D;
static unsigned int mouse_ok=0x19;
#endif
#ifdef  BOSSLINK_KEY
static unsigned int key_mouse_switch=0x42;
static unsigned int mouse_right=0x07;
static unsigned int mouse_left=0x47;
static unsigned int mouse_up=0x1a;
static unsigned int mouse_down=0x48;
static unsigned int mouse_ok=0x06;
#endif
#ifdef  NO_MOUSE 
static unsigned int key_mouse_switch=0xff;
static unsigned int mouse_right=0xff;
static unsigned int mouse_left=0xff;
static unsigned int mouse_up=0xff;
static unsigned int mouse_down=0xff;
static unsigned int mouse_ok=0xff;
#endif


#ifdef CONFIG_REMOTE_CTRL_YPBPR
extern void set_ypbpr_flag(int flag);
extern int get_ypbpr_flag(void) ;
extern void YPBPRCtrl(int flag) ;
#endif

extern void LedFlicker(void);
